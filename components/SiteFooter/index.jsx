        ...
        return (
            <footer role='content-info' className='tc'>
                <div className="mb2 fw7">
                  <p>
                      <a href={ config.socialTwitterURL } className="link green hover-navy dib mr3" title="@jonheslop on Twitter">
                     ...
                     <a href={ config.socialInstgramURL } className="link green hover-navy dib" title="Jon Heslop on Instagram">
                     ...
                     <a href={ config.socialLinkedInURL } className="link green hover-navy dib ml3" title="Jon Heslop's LinkedIn profile">
